/**
 * Helper functions and constants for distributed dynamic limits tests (Test 32).
 *
 * Config: high-distributedBasic
 * - model-alpha: TPM=100K
 * - jobTypeA: estimatedTokens=10K, estimatedRequests=1, ratio=1.0
 * - 2 instances: floor(100K/10K/2) = 5 slots per instance initially
 */
...
export const INITIAL_TPM_PER_INSTANCE = 50_000;

// Token amounts
export const TOKENS_10K = 10_000;
export const TOKENS_20K = 20_000;
export const TOKENS_30K = 30_000;
...
export const INITIAL_SLOTS = 5;
export const SLOTS_AFTER_20K_USAGE = 4;
export const SLOTS_AFTER_60K_USAGE = 2;
