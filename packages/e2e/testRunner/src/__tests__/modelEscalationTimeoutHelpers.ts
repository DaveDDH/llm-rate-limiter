/**
 * Helper functions and constants for model escalation timeout tests (21.1-21.4).
 *
 * Tests verify escalation after maxWaitMS timeout.
 */
...
export const WAIT_3S = 3000;
export const WAIT_TOTAL_8S = 8000;
export const WAIT_TOLERANCE_MS = 500;
export const WAIT_MIN_5S = 4500;
